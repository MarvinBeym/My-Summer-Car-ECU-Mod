...
namespace DonnerTech_ECU_Mod.fuelsystem
{
	public class OriginalPart
	{
		...
		public OriginalPart(string partName, string parentInstalledName, GameObject fsmGameObject,
			Vector3 originalPosition, Quaternion originalRotation, bool originalInstalled)
		{
