...
{
    public class AWD_Differential_Part : Part
    {
        public AWD_Differential_Part(PartSaveInfo inPartSaveInfo, GameObject inPart, GameObject inParent, Trigger inPartTrigger, Vector3 inPartPosition, Quaternion inPartRotation) : base(inPartSaveInfo, inPart, inParent, inPartTrigger, inPartPosition, inPartRotation)
        {
        ...
        public override PartSaveInfo defaultPartSaveInfo => new PartSaveInfo()
        {
            ...
            position = DonnerTech_ECU_Mod.awd_differential_part_spawnLocation, //Sets the spawn location -> where i can be found
