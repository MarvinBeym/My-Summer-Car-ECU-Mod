...
{
    public class TcsPart : Part
    {
        private ScrewablePart screwablePart;
        private Vector3 installLocation;

        public TcsPart(PartSaveInfo partSaveInfo, GameObject part, GameObject partParent, Trigger trigger, Vector3 installLocation, Quaternion installRotation) : base(partSaveInfo, part, partParent, trigger, installLocation, installRotation)
        {
