...
{
    public class ECU_MOD_ESPModule_Part : Part
    {
        public ECU_MOD_ESPModule_Part(PartSaveInfo inPartSaveInfo, GameObject inPart, GameObject inParent, Trigger inPartTrigger, Vector3 inPartPosition, Quaternion inPartRotation) : base(inPartSaveInfo, inPart, inParent, inPartTrigger, inPartPosition, inPartRotation)
        {
        ...
        protected override void assemble(bool startUp = false)
        {
            ...
            if (DonnerTech_ECU_Mod.ecu_mod_espModule_Part_screwable != null)
            {
                DonnerTech_ECU_Mod.ecu_mod_espModule_Part_screwable.setScrewsOnAssemble();
            }
        }
        ...
        protected override void disassemble(bool startup = false)
        {
            ...
            if (DonnerTech_ECU_Mod.ecu_mod_espModule_Part_screwable != null)
            {
                DonnerTech_ECU_Mod.ecu_mod_espModule_Part_screwable.resetScrewsOnDisassemble();
            }
