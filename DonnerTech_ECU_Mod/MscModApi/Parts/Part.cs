...
namespace MscModApi.Parts
{
	public class Part
	{
			...
			bool disableCollisionWhenInstalled, string prefabName)
		{
			...
			if (!DonnerTech_ECU_Mod.DonnerTech_ECU_Mod.modSaveFileMapping.ContainsKey(partBaseInfo.mod.ID)) {
                DonnerTech_ECU_Mod.DonnerTech_ECU_Mod.modSaveFileMapping.Add(partBaseInfo.mod.ID, partBaseInfo.saveFilePath);
			}

			if (DonnerTech_ECU_Mod.DonnerTech_ECU_Mod.modsParts.ContainsKey(partBaseInfo.mod.ID)) {
                DonnerTech_ECU_Mod.DonnerTech_ECU_Mod.modsParts[partBaseInfo.mod.ID].Add(id, this);
			} else {
                DonnerTech_ECU_Mod.DonnerTech_ECU_Mod.modsParts.Add(partBaseInfo.mod.ID, new Dictionary<string, Part>
				{
					{id, this}
				});
			}

			if (DonnerTech_ECU_Mod.DonnerTech_ECU_Mod.globalScrewPlacementModeEnabled.Contains(partBaseInfo.mod))
			{
		...
		public void AddScrew(Screw screw)
		{
            ...
            DonnerTech_ECU_Mod.DonnerTech_ECU_Mod.screws.Add(screw.gameObject.name, screw);
		}
