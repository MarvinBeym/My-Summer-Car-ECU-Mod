...
using Shop = MscModApi.Shopping.Shop;
...
namespace DonnerTech_ECU_Mod
{
    public class DonnerTech_ECU_Mod : Mod
    {
        ...
        public Settings showBoltSizeSetting = new Settings("showBoltSizeSetting", "Show screw size", false);
        ...
        internal bool ShowScrewSize => (bool)showBoltSizeSetting.Value;
        private bool loadedAssets = false;

        public override void OnNewGame()
        {
            SaveLoad.SerializeSaveFile(this, new Dictionary<string, PartSave>(), "parts_saveFile.json");
        ...
        public override void OnLoad()
        {
            ...
            fuel_injectors_box = new Box("fuel_injector", "Fuel Injector", fuel_injectors_box_gameObject, fuel_injector,
                ...
                new[]
                {
                    ...
                    new Vector3(30, 0, 0),
                    new Vector3(30, 0, 0),
                }, MscModApi.Shopping.Shop.SpawnLocation.Fleetari.Counter);
        ...
        public override void Update()
        {
            fuel_system.Handle();
            info_panel.Handle();
            MscModApi.Shopping.Shop.Handle();
#if DEBUG
            InstantInstallDebug();
#endif
        ...
        private void LoadAssets()
        {
            ...
            var assetBundle = Helper.LoadAssetBundle(this, "msc-mod-api.unity3d");
            Screw.LoadAssets(assetBundle);
            Part.LoadAssets(assetBundle);
            MscModApi.Shopping.Shop.LoadAssets(assetBundle);
