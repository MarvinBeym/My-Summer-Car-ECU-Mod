...
{
    public class AWD_Gearbox_Part : Part
    {
        public AWD_Gearbox_Part(PartSaveInfo inPartSaveInfo, GameObject inPart, GameObject inParent, Trigger inPartTrigger, Vector3 inPartPosition, Quaternion inPartRotation) : base(inPartSaveInfo, inPart, inParent, inPartTrigger, inPartPosition, inPartRotation)
        {
        ...
        public override PartSaveInfo defaultPartSaveInfo => new PartSaveInfo()
        {
            ...
            position = DonnerTech_ECU_Mod.awd_gearbox_part_spawnLocation, //Sets the spawn location -> where i can be found
